...
GRANT INSERT ON accounts, eligibility, eligibility_reviews, market_templates,
  ...
  contact_verifications, contact_verification_events, identity_inquiries, identity_provider_events, withdrawals, reconciliation_runs
  TO afridict_runtime;
...
GRANT UPDATE ON eligibility, eligibility_reviews, market_proposals, markets,
  ...
  deposit_intents, withdrawals, account_assurance, contact_verifications, identity_inquiries TO afridict_runtime;
