...
export const RfqRequestSchema=object({id:UUID,entity_id:UUID,market_id:UUID,asset_code:Type.String(),contract_unit_minor:Uint,outcome_id:Type.String(),
...
export const RfqQuoteSchema=object({id:UUID,request_id:UUID,dealer_entity_id:UUID,asset_code:Type.String(),contract_unit_minor:Uint,price:Uint,expires_at:Timestamp,
...
export const RfqFillSchema=object({id:UUID,request_id:UUID,quote_id:UUID,market_id:UUID,asset_code:Type.String(),contract_unit_minor:Uint,outcome_id:Type.String(),
