...
export const AmmPoolSchema=object({market_id:UUID,outcome_id:Type.String(),asset_code:Type.String(),
  status:Type.String({enum:['open','halted']}),inventory_limit:Uint,subsidy_limit:Uint,loss_limit:Uint,
...
export const AmmQuoteSchema=object({id:UUID,market_id:UUID,outcome_id:Type.String(),side:Type.String({enum:['buy','sell']}),
